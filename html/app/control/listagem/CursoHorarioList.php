...
class CursoHorarioList extends TPage
{
    private $form; // form
    ...
    private static $formName = 'formList_CursoHorario';
    ...
    public function __construct()
    {
        ...
        $curso_id = new TDBCombo('curso_id', 'sas', 'Curso', 'nome_curso', '{nome_curso}','curso_id asc'  );
        ...
        $this->datagrid->addColumn($column_horarios_horario);
        $this->datagrid->addColumn($column_curso_nome_curso);
    ...
    { 
        if(isset($param['delete']) && $param['delete'] == 1)
        {
            try
            {
                ...
                // instantiates object
                $object = new CursoHorario($key, FALSE); 
