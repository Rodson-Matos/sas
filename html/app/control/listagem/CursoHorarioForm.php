...
class CursoHorarioForm extends TPage
{
    protected $form;
    private $formFields = [];
    ...
    private static $formName = 'form_CursoHorario';
    ...
    public function onSave($param = null) 
    {
        try
        {
            ...
            **/
            ...
            $object = new CursoHorario(); // create an empty object 
    ...
    public function onEdit( $param )
    {
        try
        {
            if (isset($param['key']))
            {
                ...
                $object = new CursoHorario($key); // instantiates the Active Record 
